      ...
      <div className="flex flex-col   xl:space-y-36 space-y-8 md:space-y-28">
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1 md:items-end z-10">
                <span className="text-AAsecondary text-base">Aurodigital </span>
                <a
                  href="https://aurodigital.ai"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
                    Aurodigital SaaS Platform
                  </span>
                </a>
              </div>
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  At <span className="text-AAsecondary">Aurodigital</span>, I
                  ...
                  achievement was the release of SaaS platform with{" "}
                  <span className="text-AAsecondary">Aggregated</span>{" "}
                  <span className="text-AAsecondary">OrderBook</span>. This
              ...
              >
                <span className="pr-4 z-10">Cryptocurrency</span>
                <span className="pr-4 z-10">Orderbook</span>
                <span className="pr-4 z-10">Web3</span>
                <span className="pr-4 z-10">Aggregated</span>
                <span className="pr-4 z-10">Exchange</span>
              </ul>
        ...
        >
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a
                href={
                  "https://play.google.com/store/apps/details?id=com.moeving.app&hl=en_US&pli=1"
                }
                target="_blank"
                rel="noreferrer"
              >
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              <div className="flex flex-col space-y-1  z-10">
                ...
                <a
                  href="https://play.google.com/store/apps/details?id=com.moeving.app&hl=en_US&pli=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <span className=" md:text-gray-200 text-AAsecondary font-bold text-xl hover:cursor-pointer">
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  The moEVing Partner App enables drivers to seamlessly
                  collaborate with diverse clients on the moEVing platform.
                  Enjoy flexible work hours, earn incentives, and embrace
                  benefits as a moEVing Delivery Partner. 🌟 Earn bonuses for
                  your commitment ⏰ Choose your own flexible hours 🛵 Opt for
                  full-time or part-time work with various clients
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
              ...
              >
                ...
                <span className="pr-4 z-10">CodePush</span>
                <span className="pr-4 z-10">Logistics</span>
                <span className="pr-4 z-10">EV</span>
                <span className="pr-4 z-10">Billing</span>
              </ul>
              {/* <div className="z-10 flex fle-row space-x-5 ">
        ...
        >
          ...
          >
            <div className="relative rounded w-full h-full col-span-7 ">
              <a
                href="https://www.everywhereagents.com"
                target={"_blank"}
                rel="noreferrer"
              >
                <div
        ...
        >
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a
                href="https://apps.apple.com/in/app/ew-agent/id1582443078"
                target={"_blank"}
                rel="noreferrer"
              >
                <div
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            >
              ...
              >
                ...
                <span className="pr-4 z-10">Location tracking alerts</span>
              </ul>
              <div className="z-10 flex fle-row space-x-5 sm:pt-0 pt-2">
